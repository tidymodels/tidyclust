...
- Added a “Getting started with tidyclust” vignette
  ([`vignette("tidyclust")`](https://tidyclust.tidymodels.org/articles/tidyclust.md)).
...
- [`contr_one_hot()`](https://tidyclust.tidymodels.org/reference/contr_one_hot.md)
  ...
  [`.convert_form_to_x_fit()`](https://tidyclust.tidymodels.org/reference/convert_helpers.md)
  and
  [`.convert_form_to_x_new()`](https://tidyclust.tidymodels.org/reference/convert_helpers.md).
...
- Exported internal functions `ClusterR_kmeans_fit()`,
  ...
  [`.k_means_fit_ClusterR()`](https://tidyclust.tidymodels.org/reference/dot-k_means_fit_ClusterR.md),
  [`.k_means_fit_stats()`](https://tidyclust.tidymodels.org/reference/dot-k_means_fit_stats.md),
  and
  [`.hier_clust_fit_stats()`](https://tidyclust.tidymodels.org/reference/dot-hier_clust_fit_stats.md)
