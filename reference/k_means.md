...
- [stats](https://tidyclust.tidymodels.org/reference/details_k_means_stats.md):
  Classical K-means

- [ClusterR](https://tidyclust.tidymodels.org/reference/details_k_means_ClusterR.md):
  Classical K-means

- [klaR](https://tidyclust.tidymodels.org/reference/details_k_means_klaR.md):
  K-Modes

- [clustMixType](https://tidyclust.tidymodels.org/reference/details_k_means_clustMixType.md):
  K-prototypes
